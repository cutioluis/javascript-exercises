...
//Haz una función que devuelva una lista con todas las ovejas que sean de color rojo y que además su nombre,
...
function oF(ovejas) {
  return ovejas
    .filter((e) => e.color === "rojo")
    .filter((e) => e.name.includes("N"))  
